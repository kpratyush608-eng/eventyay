    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(default='org@mail.com', help_text='Will be used as Reply-To in emails.', max_length=254, verbose_name='Organizer email address')),
                ...
                ('locale', models.CharField(choices=[('en', 'English'), ('de', 'German'), ('de-formal', 'German (formal)'), ('ar', 'Arabic'), ('cs', 'Czech'), ('el', 'Greek'), ('es', 'Spanish'), ('fa-ir', 'Persian'), ('fr', 'French'), ('it', 'Italian'), ('ja-jp', 'Japanese'), ('nl', 'Dutch'), ('pt-br', 'Brasilian Portuguese'), ('pt-pt', 'Portuguese'), ('ru', 'Russian'), ('sw', 'Swahili'), ('ua', 'Ukrainian'), ('zh-hant', 'Traditional Chinese (Taiwan)'), ('zh-hans', 'Simplified Chinese')], default='en', max_length=32, verbose_name='Default language')),
                ...
                ('roles', models.JSONField(blank=True, default=eventyay.base.models.event.default_roles, encoder=eventyay.core.utils.json.CustomJSONEncoder, null=True)),
                ('trait_grants', models.JSONField(blank=True, default=eventyay.base.models.event.default_grants, null=True)),
                ('domain', models.CharField(blank=True, max_length=250, null=True, unique=True, validators=[django.core.validators.RegexValidator(regex='^[a-z0-9-.:]+(/[a-zA-Z0-9-_./]*)?$')])),
            ...
            bases=(eventyay.base.models.event.EventMixin, eventyay.base.models.mixins.FileCleanupMixin, rules.contrib.models.RulesModelMixin, models.Model, eventyay.base.models.base.LoggingMixin),
        ),
        migrations.CreateModel(
            name='EventLock',
            fields=[
        ...
        migrations.CreateModel(
            ...
            bases=(rules.contrib.models.RulesModelMixin, models.Model, eventyay.base.models.base.LoggingMixin),
        ),
        migrations.CreateModel(
            name='Page',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_id', models.CharField(blank=True, db_index=True, max_length=200, null=True)),
                ('token_id', models.CharField(blank=True, db_index=True, max_length=200, null=True)),
                ('moderation_state', models.CharField(choices=[('', 'None'), ('silenced', 'Silenced'), ('banned', 'Banned')], default='', max_length=8)),
                ('type', models.CharField(choices=[('person', 'Person'), ('kiosk', 'Kiosk'), ('anon', 'Anonymous')], default='person', max_length=8)),
                ('show_publicly', models.BooleanField(default=True)),
                ('profile', models.JSONField(default=dict)),
                ('client_state', models.JSONField(default=dict)),
                ('traits', models.JSONField(blank=True, default=list)),
                ('pretalx_id', models.CharField(blank=True, max_length=200, null=True)),
                ('last_login', models.DateTimeField(blank=True, null=True)),
                ('deleted', models.BooleanField(default=False)),
                ('social_login_id_twitter', models.CharField(blank=True, db_index=True, max_length=190, null=True)),
                ('social_login_id_linkedin', models.CharField(blank=True, db_index=True, max_length=190, null=True)),
                ('code', models.CharField(max_length=16, null=True, unique=True)),
                ('nick', models.CharField(blank=True, max_length=60, null=True)),
                ('is_administrator', models.BooleanField(default=False, help_text='Should only be ``True`` for people with administrative access to the server eventyay runs on.')),
                ('avatar', models.ImageField(blank=True, help_text='We recommend uploading an image at least 400px wide. A square image works best, as we display it in a circle in several places.', null=True, upload_to=eventyay.base.models.auth.avatar_path, verbose_name='Profile picture')),
                ('avatar_thumbnail', models.ImageField(blank=True, null=True, upload_to='avatars/')),
                ('avatar_thumbnail_tiny', models.ImageField(blank=True, null=True, upload_to='avatars/')),
                ('get_gravatar', models.BooleanField(default=False, help_text='If you have registered with an email address that has a gravatar account, we can retrieve your profile picture from there.', verbose_name='Retrieve profile picture via gravatar')),
                ('avatar_source', models.TextField(blank=True, help_text='Please enter the name of the author or source of image and a link if applicable.', null=True, verbose_name='Profile Picture Source')),
                ('avatar_license', models.TextField(blank=True, help_text='Please enter the name of the license of the photo and link to it if applicable.', null=True, verbose_name='Profile Picture License')),
                ('pw_reset_token', models.CharField(max_length=160, null=True, verbose_name='Password reset token')),
            ...
            bases=(eventyay.base.models.base.LoggingMixin, rules.contrib.models.RulesModelMixin, eventyay.base.models.mixins.GenerateCode, eventyay.base.models.mixins.FileCleanupMixin, models.Model),
        ),
        migrations.CreateModel(
            name='ChatEvent',
            fields=[
        ...
        migrations.AddField(
            model_name='channel',
            name='event',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='channels', to='base.event'),
        ),
        migrations.CreateModel(
            name='BBBServer',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trait_grants', models.JSONField(blank=True, default=eventyay.base.models.room.default_grants, null=True)),
                ('module_config', models.JSONField(default=eventyay.base.models.room.empty_module_config, null=True)),
        ...
        migrations.AddField(
            model_name='poster',
            name='parent_room',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='child_posters', to='base.room'),
        ),
        migrations.AddField(
            model_name='poster',
            name='presentation_room',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='presentation_posters', to='base.room'),
        ),
        migrations.AddField(
            model_name='poll',
            name='room',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='polls', to='base.room'),
        ),
        migrations.AddField(
            model_name='exhibitor',
            name='highlighted_room',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='highlighted_by_exhibitors', to='base.room'),
        ),
        migrations.AddField(
            model_name='exhibitor',
            name='room',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='exhibitors', to='base.room'),
        ),
        migrations.AddField(
            model_name='channel',
            name='room',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='channel', to='base.room'),
        ),
        migrations.CreateModel(
            name='BBBCall',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('can_change_submissions', models.BooleanField(default=False, verbose_name='Can work with and change proposals')),
                ('is_reviewer', models.BooleanField(default=False, verbose_name='Is a reviewer')),
                ('force_hide_speaker_names', models.BooleanField(default=False, help_text='Normally, anonymisation is configured in the event review settings. This setting will <strong>override the event settings</strong> and always hide speaker names for this team.', verbose_name='Always hide speaker names')),
                ('limit_events', models.ManyToManyField(blank=True, to='base.event', verbose_name='Limit to events')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('object_id', models.JSONField(encoder=django.core.serializers.json.DjangoJSONEncoder)),
                ('datetime', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('action_type', models.CharField(max_length=255)),
                ('data', models.TextField(default='{}')),
