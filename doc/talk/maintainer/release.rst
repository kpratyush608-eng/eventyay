...
9. Add the release on `GitHub <https://github.com/fossasia/eventyay/releases>`_ (upload the archive you uploaded to PyPI, and add a link to the correct section of the :ref:`changelog`)
